<template>
  ...
  >
    ...
    <v-form ref="matchForm">
      <v-container>
        <CalculatorMatchTeam ground="home" :index="index" :match="match"></CalculatorMatchTeam>
        <CalculatorMatchTeam ground="away" :index="index" :match="match"></CalculatorMatchTeam>
        <v-row dense>
          <v-col>
            <v-switch
